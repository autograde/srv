...
var testNewConfigInput = []struct {
	url, admin, id, secret, path string
}{
	{"http://example.com", admin, "1234", "abcd", "/tmp"},
	{"http://example2.com", admin, "123456789", "abcdef", "/tmp"},
	{"http://example3.com", admin, "987654321", "abcd123456789", "/tmp"},
	{"http://example4.com", admin, "1234acd544", "abcd455813aa", "/tmp"},
	{"http://example5.com", admin, "123accd224", "422abcd54adcb4442272882adedff35f3fe3", "/usr/share/ag"},
}

func TestNewConfig(t *testing.T) {
	for _, in := range testNewConfigInput {
		conf, err := NewConfig(in.url, in.admin, in.id, in.secret, in.path)
		if err != nil {
			t.Error(err)
			continue
		}
...
func TestSetCurrent(t *testing.T) {
	...
	for _, in := range testNewConfigInput[0:1] {
		conf, _ := NewConfig(in.url, in.admin, in.id, in.secret, in.path)
		conf.SetCurrent()
	}
}
...
var testNewConfigRemoveSuffixInput = []struct {
	url, admin, id, secret, path, out string
}{
	{"http://example1.com", admin, "1234acd544", "abcd455813aa", "/tmp", "http://example1.com"},
	{"http://example2.com/", admin, "1234acd544", "abcd455813aa", "/tmp", "http://example2.com"},
}
...
var testNewConfigFailInput = []struct {
	...
	{"", admin, "1234", "abcd", "/tmp"},
	{"http://example2.com", admin, "", "abcdef", "/tmp"},
	{"http://example3.com", admin, "987654321", "", "/tmp"},
	{"http://example4.com", admin, "1234acd544", "abcd455813aa", ""},
	{"http://example5.com", admin, "123accd224", "", "/usr/share/ag"},
	{"", admin, "", "", "/usr/share/ag"},
	{"", admin, "", "", ""},
}
